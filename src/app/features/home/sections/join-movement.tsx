    ...
    return (
        <Box as="section">
            <Container py={100}>
                ...
                <Heading mt={4} size={["2xl", "4xl"]} maxW={"lg"} wordBreak={"break-word"}>
...
const items = [
    {
        label: "Volunteer",
        description: "Join local cleanups, school visits and community sorting days.",
        action: {
            label: "Sign Up",
            href: "#"
        }
    ...
    {
        label: "School",
        description: "Bring climate literacy into your classroom with our free teacher toolkit.",
        action: {
    ...
    {
        label: "Partners",
        description: "Governments, NGOs and funders let's build something at scale.",
        action: {
