    ...
    <Box as="section" py={100}>
      <Container>
        ...
        >
          ...
          >
            Four practices, one continental mission.
          </Heading>
          {mode == "compact" ? (
            <WVLink href="/about" borderColor={"primary"} color={"primary"}>
            ...
            {WhatWeDoData.map((item, i) => {
              ...
              return (
                <Card.Root key={i} rounded={"xl"}>
                  <Card.Header p={4} pos={"relative"} overflow={"clip"}>
                    {item.featured && (
